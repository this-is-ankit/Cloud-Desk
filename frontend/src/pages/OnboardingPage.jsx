      ...
      <PageContainer className="py-12">
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-base-content/10 bg-base-100 p-8 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-primary">
            Welcome to Cloud Desk
          </p>
          <h1 className="mt-3 text-4xl font-black tracking-tight">
            Set up the workspace you want to use.
          </h1>
          <p className="mt-4 max-w-2xl text-base text-base-content/65">
            Confirm your account role, add a short profile, and finish
            onboarding. Your role is locked after this step so the platform can
            stay consistent.
          </p>
          {authIntent && (
            <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-sm font-semibold text-primary">
              ...
              {authIntent === "teacher" ? "Teacher" : "Student"}
            </div>
          )}
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="form-control">
                ...
                <input
                  ...
                  placeholder="Frontend mentor, DSA coach, physics teacher"
                />
              </label>
              <label className="form-control">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="input input-bordered rounded-2xl"
                  placeholder="Weeknights 7-10 PM IST"
                />
              </label>
            </div>
            ...
            <label className="form-control">
              ...
              <textarea
                ...
                placeholder="Describe what you teach or what you want to learn."
              />
            </label>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="form-control">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="input input-bordered rounded-2xl"
                  placeholder="javascript, dsa, calculus"
                />
              </label>
              <label className="form-control">
                <span className="mb-2 text-sm font-medium">
            ...
            <label className="flex items-center gap-3 rounded-2xl border border-base-content/10 bg-base-200/40 p-4">
              ...
              <span className="text-sm">
                Make my profile discoverable in the public teacher directory
              </span>
            </label>
